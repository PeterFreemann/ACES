      ...
      <section className="bg-base-200 p-6 bg-gray-300">
        <footer className="footer grid grid-cols-1 md:grid-cols-4 gap-8 p-10 ">
          ...
          <nav className="text-base-content grid text-left">
            ...
            <a href="#" className="link text-grey-200 link-hover font-serif">Branding</a>
            <a href="#" className="link link-hover font-serif">Design</a>
          ...
          <nav className="text-base-content grid text-left">
            ...
            <a href="#" className="link link-hover font-serif">About us</a>
            <a href="#" className="link link-hover font-serif">Contact</a>
            <a href="#" className="link link-hover font-serif">Jobs</a>
            <a href="#" className="link link-hover font-serif">Press kit</a>
          </nav>
  
          <nav className="text-base-content grid text-left">
            <h6 className="footer-title font-semibold text-lg font-serif">Legal</h6>
            <a href="#" className="link link-hover font-serif">Terms of use</a>
            <a href="#" className="link link-hover font-serif">Privacy policy</a>
            <a href="#" className="link link-hover font-serif">Cookie policy</a>
          </nav>
        </footer>
      </section>
    );

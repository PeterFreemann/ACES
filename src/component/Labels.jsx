...
export default function Label() {
  return (
    <section>
        <h1 className="text-5xl pt-10 pb-8 px-5  font-bold text-gray-600 font-serif">The biggest labels</h1>
      <div className="  ">
...
<button className="text-5xl py-10 px-5 font-bold text-gray-600 font-serif">Shop women's brands</button>
      </div>
    </section>
  );
}
